...
In the future, I'd like to focus more on user feedback and early wireframing, as these processes were most insightful in informing the high fidelity prototypes. Also, I'd like to incorporate more ideas and functions from users. PubMed is a comprehensive resource with many avenues for improvement, and citations, searching, and reading articles are only some of the most important functions that users do. Finally, I would like to create a more systematic and informative revision process that helps me document my thought process. This helps me learn better from my mistakes so that I can create even better design workflows in the future.
